...
<html lang="en">
 <head>
  ...
  <title>Ulchi.Rohithkumar - Cyber Athlete Portfolio</title>
 ...
 <body>
  ...
  <main><!-- Hero Section -->
   <section class="hero-section">
    <div class="athlete-card neon-glow">
     ...
     <h1 class="athlete-name" id="athlete-name">Rohithkumar</h1>
   ...
   <section class="achievements-section">
    ...
    <div style="max-width: 1000px; margin: 0 auto;">
     ...
     <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://github.com/rohithkumar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        💻
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://medium.com/@rohithkumar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        📝
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://youtube.com/@RohithkumarCyber', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        📺
       </div>
  ...
  <script>
        ...
        const defaultConfig = {
            ...
            linkedin_handle: "@rohithkumar",
            github_handle: "@rohithkumar",
            twitter_handle: "@rohith_sec",
            discord_handle: "rohithk#2024",
            medium_handle: "@rohith",
            youtube_handle: "RohithCyber"
        };
